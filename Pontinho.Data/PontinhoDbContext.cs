...
namespace Pontinho.Data
{
    public partial class PontinhoDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        public PontinhoDbContext(CurrentUserService currentUserService) : base() // base("name=PontinhoEntities")
        {
            _currentUserService = currentUserService;
        }
        public PontinhoDbContext() : base("name=PontinhoEntities") { }

        public PontinhoDbContext(string connectionString, CurrentUserService currentUserService) : base(connectionString)
        {
            _currentUserService = currentUserService;
        }

        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JoiningFee = table.Column<decimal>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Competitions_Players_WinnerId",
                        column: x => x.WinnerId,
                        principalTable: "Players",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    CardingId = table.Column<int>(nullable: true),
                    CreatedBy = table.Column<string>(nullable: true),
                    CreatedUtc = table.Column<DateTime>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rounds_Players_CardingId",
                        column: x => x.CardingId,
                        principalTable: "Players",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PointsLost = table.Column<int>(nullable: false),
                    RoundId = table.Column<int>(nullable: false),
                    Status = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoundPlayerStats", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoundPlayerStats_Players_PlayerId",
                        column: x => x.PlayerId,
                        principalTable: "Players",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoundPlayerStats_Rounds_RoundId",
                        column: x => x.RoundId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoundPlayerStats_PlayerId",
                table: "RoundPlayerStats",
                column: "PlayerId");

            migrationBuilder.CreateIndex(
                name: "IX_RoundPlayerStats_RoundId",
                table: "RoundPlayerStats",
                column: "RoundId");

            migrationBuilder.AddForeignKey(
                name: "FK_Players_Competitions_CompetitionId",
                table: "Players",
                column: "CompetitionId",
                principalTable: "Competitions",
                principalColumn: "Id",
